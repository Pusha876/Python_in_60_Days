...
def generate(
    invoices_path, pdfs_path, image_path, product_id, product_name,
    amount_purchased, price_per_unit, total_price
):
    """
    This function converts invoices from Excel files to PDF files.

    Args:
        invoices_path (_type_): _description_
        pdfs_path (_type_): _description_
        image_path (_type_): _description_
        product_id (_type_): _description_
        product_name (_type_): _description_
        amount_purchased (_type_): _description_
        price_per_unit (_type_): _description_
        total_price (_type_): _description_
    """
