...
setup(
  name='invoicing-pdf-03-19-2025',         # Your package will have this name
  ...
  # More here: https://help.github.com/articles/licensing-a-repository
  description=(
    'This package can be used to convert Excel invoices to PDF invoices.'
  ),    # Short description of your library
  author='Jamie Pryce',                   # Your name
  author_email='djpusha876@gmail.com',  # Your email
  url=(
    'https://jamie.pryce.com'
